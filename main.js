...
function catalogMaker(place, num) {
  for (let i = 0; i < num; i++) {
    place.append(`
        <div>
...
catalogMaker($(".firstPageCatalog"), 6);
catalogMaker($(".thirdPageMiniCatalog"), 3);
...
$(".firstPage h2").click(function () {
  catalogMaker($(".firstPageCatalog"), 3);
...
$(".firstPageCatalog a").click(function () {
  console.log($(this).attr('id'));
  location.href= $(this).attr('id') + '.html';
});

$(".firstPageContentLeft img").click(function () {
  // console.log($(this).attr('src'));
  let mainSrc = $("#mainImage").attr('src');
  let minorSrc = $(this).attr('src');
  $("#mainImage").attr('src', minorSrc);
